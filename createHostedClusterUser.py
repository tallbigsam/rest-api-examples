...
def request_user_creation(cluster_id, username, password, buckets_and_scope):
    ...
    for bucket_and_scope_entry in buckets_and_scope.split(','):
    ...
    if capella_api.api_status().status_code == 200:
        capella_api_response = capella_api.create_cluster_user(True, cluster_id, cluster_user_struct)
...
def main(cmd_line_args):
    ...
    request_user_creation(cmd_line_args.cluster_id, cmd_line_args.user_name, cmd_line_args.password, cmd_line_args.buckets_and_scope)
